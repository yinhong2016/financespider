  ...
  private void processCube(CubeEntity cube, JsonNode node) {
    ...
    for (JsonNode jsonNode : list) {
      for (JsonNode jn : jsonNode.get("rebalancing_histories")) {
        ...
        RebalancingEntity.TrendBlock trendBlock =
            new RebalancingEntity.TrendBlock(stock_name, stock_symbol, created_at, prev_price,
                price, prev_weight, target_weight, weight, rebalancing_id);
