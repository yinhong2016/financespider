 ...
 * @Description: 股票走势
 */
public class StockTrendEntity extends TrendEntity<StockTrendEntity.TrendBlock, StockTrendEntity> {

  private static final long serialVersionUID = -359837864117441459L;
  ...
  public static class TrendBlock implements ITrendBlock {
    ...
    private static final long serialVersionUID = 4285277881908809504L;
     ...
     * @param time 时间节点
     */
    public TrendBlock(String volume, String open, String high, String close, String low, String chg,
        String percent, String turnrate, String ma5, String ma10, String ma20, String ma30,
        String dif, String dea, String macd, String time) {
      this.volume = volume;
      this.open = open;
      this.high = high;
      this.close = close;
  ...
  public StockTrendEntity(String stockNo, Period period, List<TrendBlock> history) {
    super(history);
    this.period = period;
  ...
  public StockTrendEntity copy() {
    return new StockTrendEntity(stockNo, period, new ArrayList<>(history));
  }
